...
def main(cfg: DictConfig) -> Optional[float]:
    ...
    print('oracle_dir:', cfg.runner.oracle_dir)
    print('predictor_dir:', cfg.runner.predictor_dir)
    ...
    # Hacky but it works...
    print(samples_dir)
    if exp_cfg.base_seqs is not None:
        cfg.runner.base_pool_path = exp_cfg.base_seqs
    else:
        num_mutations = [
